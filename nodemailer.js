...
export async function sendFailureEmail(transport, result) {
    transport.sendMail({
        from: '"Meine Breitbandmessung" <noreply@auwes.de>',
        to: 'test-qw6j4wtk3@srv1.mail-tester.com',//'joscha.auwaerter@outlook.com',
        subject: 'Testmail von Node.js',
        text: 'Hallo! Dies ist eine Testmail von deinem Node.js Server.',
        html: '<p>Hallo! <strong>Dies ist eine Testmail</strong> von deinem Node.js Server.</p>'
    }, (error, info) => {
        if (error) {
            return console.log('Fehler beim Senden:', error);
        }
